...
public class AddStocksFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cmbTax, 0, 120, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 0, 0), 4, true));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
      ...
      try
      {  //YAHAAA EXCEPTION thi jo solve hogyi
          
          
          
          int len=cmbTax.getSelectedItem().toString().length();
          int tax=Integer.parseInt(cmbTax.getSelectedItem().toString().substring(0,len-1));
          ...
          if(result)
          {
             ...
             JOptionPane.showMessageDialog(null, "Products Not Saved", "Not Saved!", JOptionPane.ERROR_MESSAGE);
                ...
                {
                    JOptionPane.showMessageDialog(null, "Please comntact software provider", "Technical Error!", JOptionPane.ERROR_MESSAGE);
                    np.printStackTrace();
                } 
